...
def load_xde( xde_params, pde_params, nn_params, scalings,  geom, bc, fnames):

    ndim, nvar, epochs, n, w1, w2, w3, wa = xde_params           = xde_params
    Re,                                                          = pde_params
    ...
    model.restore(file_name + '-' + str(epochs) + '.ckpt', verbose=1)
