...
def get_anchor(Nx_anchor, Ny_anchor, y_loc, alpha, beta, xs, ys, x_coor, y_coor, X, Y, Ygridded):   # Problem configuration dependent
    ...
    mask                   = X_anchors[:,1] >= y_loc                   # delta_nu ~ 0.027 for the TBL
    X_anchors_masked       = X_anchors[mask]
    kdtree                 = KDTree(Xloc)
    d, idx_anchors         = kdtree.query(X_anchors_masked)
