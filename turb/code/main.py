...
act = {1:"tanh", 2:"relu"}
lr, lyr, wid, actv, epch, n, lossw1, lossw2, lossw3, losswa, nxm, nym, y_loc, alpha, beta, bctype = inp.T
...
for c in range(c0,c1):
    ...
    data_params = [Re, int(nxm[c]), int(nym[c]), y_loc[c], alpha[c], beta[c], bctype[c]]
